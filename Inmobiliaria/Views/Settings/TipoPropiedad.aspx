                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button ID="btn_Guardar" runat="server" CssClass="btn btn-default btn-save" Text="Guardar" ValidationGroup="Propiedad" data-dismiss="modal" UseSubmitBehavior="false" OnClick="btn_Guardar_Click" />
                            </div>
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
            ...
            <div class="col-md-12">
                <div class="card border-light mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-10">
                                <h4 class="card-title" style="color: #0c2b54">Tipos de propiedades</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <ContentTemplate>
                                <div class="table table-hover table-responsive" style="font-size: small">
                                    <asp:GridView ID="grdTipoPropiedades" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered"
                                        DataKeyNames="IdTipoPropiedad" AllowPaging="true" PageSize="10" PagerSettings-Mode="Numeric"
                                        OnPageIndexChanging="grdTipoPropiedades_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IdTipoPropiedad" HeaderText="#" HeaderStyle-BackColor="#0c2b54" HeaderStyle-ForeColor="White" />
